    ...
    <div className="min-h-screen bg-background pt-24 pb-16 relative overflow-hidden">
      ...
      <div className="container px-4 md:px-8 max-w-7xl mx-auto animate-pulse">
        ...
        <div className="flex items-center gap-2 mb-6 text-sm">
          <Skeleton className="h-4 w-12 bg-muted/20 rounded" />
          <ChevronRight className="w-3.5 h-3.5 text-muted-foreground/30" />
          <Skeleton className="h-4 w-16 bg-muted/20 rounded" />
          <ChevronRight className="w-3.5 h-3.5 text-muted-foreground/30" />
          <Skeleton className="h-4 w-32 bg-muted/30 rounded" />
        </div>
        ...
        <div className="career-detail-layout">
          ...
          <header className="card card-glass job-hero-card p-6 md:p-8">
            <div className="job-hero-top flex flex-col md:flex-row gap-6 items-start md:items-center">
              <Skeleton className="company-large-logo w-22.5 h-22.5 rounded-xl bg-muted/25" />
              <div className="job-hero-info flex-1 space-y-3">
                ...
                <Skeleton className="h-8 w-2/3 bg-muted/35 rounded" />
                <Skeleton className="h-4 w-1/3 bg-muted/20 rounded" />
              </div>
            </div>
            ...
            <div className="job-hero-stats grid grid-cols-2 md:grid-cols-4 gap-6 mt-8 pt-8 border-t border-border">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="hero-stat-item flex gap-3">
                  <Skeleton className="w-10 h-10 rounded-xl bg-muted/20 shrink-0" />
                  <div className="space-y-1.5 flex-1">
                    <Skeleton className="h-3 w-12 bg-muted/15 rounded" />
                    <Skeleton className="h-4 w-20 bg-muted/30 rounded" />
                  </div>
                </div>
              ))}
            </div>
          ...
          <main className="career-main-content space-y-6">
            ...
            <article className="card card-glass content-block-card p-6 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <Skeleton className="h-6 w-32 bg-muted/30 rounded" />
              </div>
              <div className="space-y-2">
                <Skeleton className="h-4 w-full bg-muted/20 rounded" />
            ...
            <article className="card card-glass content-block-card p-6 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <Skeleton className="h-6 w-44 bg-muted/30 rounded" />
              </div>
              <div className="space-y-3">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="flex gap-2 items-start">
                    <Skeleton className="w-4 h-4 rounded bg-muted/20 shrink-0 mt-1" />
                    <Skeleton className="h-4 w-full bg-muted/15 rounded" />
                  </div>
                ))}
              </div>
            </article>
            ...
            <article className="card card-glass content-block-card p-6 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <Skeleton className="h-6 w-52 bg-muted/30 rounded" />
              </div>
              <div className="space-y-3">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="flex gap-2 items-start">
