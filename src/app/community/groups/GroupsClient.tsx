...
export default function GroupsClient({ initialGroups }: GroupsClientProps) {
  ...
  // Fetch groups with filters initialized by SSR initialGroups
  const { groups, isLoading, refetch, createGroup, joinGroup, requestJoinGroup, memberGroupIds, pendingRequestGroupIds } = useCommunityGroups(initialGroups);
