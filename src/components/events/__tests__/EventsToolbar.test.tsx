...
describe('EventsToolbar', () => {
  ...
  it('renders search icon', () => {
    ...
    const searchIcon = screen.getByLabelText('Search events by title or description').previousSibling;
  ...
  it('has accessible search input', () => {
    ...
    const searchInput = screen.getByLabelText('Search events by title or description');
    expect(searchInput).toBeInTheDocument();
  });
