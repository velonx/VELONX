...
export const createEventSchema = z.object({
  ...
  posterUrl: z.string().url("Invalid poster URL").optional().nullable().transform((val) => val ?? undefined),
  maxSeats: z.number().int("Max seats must be an integer").positive("Max seats must be positive").optional().nullable(),
  whoCanParticipate: z.string().optional().nullable(),
